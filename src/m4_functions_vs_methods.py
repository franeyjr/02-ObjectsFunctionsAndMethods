...
def tom_jump():
    tom = rg.SimpleTurtle()
    tom.pen_up()
    tom.go_to(rg.Point(200,100))
    tom.pen_down()
    tom.go_to(rg.Point(300,30))

def dave_jump():
    dave = rg.SimpleTurtle()
    dave.pen_up()
    dave.go_to(rg.Point(100,200))
    dave.pen_down()
    dave.go_to(rg.Point(0,0))

def greg_jump():
    greg = rg.SimpleTurtle()
    greg.pen_up()
    greg.go_to(rg.Point(-50,50))
    greg.pen_down()
    greg.go_to(rg.Point(100,100))
